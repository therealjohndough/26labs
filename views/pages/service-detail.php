...
<section class="px-12 py-32 border-b border-border">
  <div class="grid grid-cols-2 gap-24 items-end">
    <div>
      ...
      <h1 class="font-serif text-5xl md:text-6xl italic font-normal leading-tight">
  ...
  <div class="px-12 py-24">
    ...
    <div class="grid grid-cols-3 gap-0.5 bg-mid mb-16">
      <div class="bg-mid p-12">
        ...
        <h3 class="font-serif text-xl italic font-normal mb-2">Strategic Foundation</h3>
      ...
      <div class="bg-mid p-12">
        <div class="text-2xl mb-4">◈</div>
        <h3 class="font-serif text-xl italic font-normal mb-2">Actionable Insights</h3>
      ...
      <div class="bg-mid p-12">
        <div class="text-2xl mb-4">◇</div>
        <h3 class="font-serif text-xl italic font-normal mb-2">Custom Framework</h3>
      ...
      <div class="bg-mid p-12">
        <div class="text-2xl mb-4">▽</div>
        <h3 class="font-serif text-xl italic font-normal mb-2">Clear Messaging</h3>
      ...
      <div class="bg-mid p-12">
        <div class="text-2xl mb-4">○</div>
        <h3 class="font-serif text-xl italic font-normal mb-2">Competitive Edge</h3>
        <p class="text-sm text-text-secondary/40 leading-relaxed">Find the whitespace. Own it. Move faster than everyone else.</p>
      </div>
      <div class="bg-mid p-12">
        <div class="text-2xl mb-4">⬡</div>
        <h3 class="font-serif text-xl italic font-normal mb-2">Deployment Ready</h3>
  ...
  <div class="px-12 py-24">
    <div class="grid grid-cols-2 gap-24">
      <div>
        ...
        <h2 class="font-serif text-3xl md:text-4xl italic font-normal leading-tight mb-8">Brands at a turning point.</h2>
...
<section class="border-b border-border relative overflow-hidden">
  <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-serif text-9xl italic text-white opacity-3 pointer-events-none whitespace-nowrap" style="font-size: clamp(100px, 18vw, 260px);">Strategy</div>
