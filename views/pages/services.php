...
<section class="px-12 py-32 border-b border-border relative overflow-hidden">
  <!-- Background text -->
  <div class="absolute top-1/2 left-12 -translate-y-1/2 font-serif italic text-white opacity-5 pointer-events-none whitespace-nowrap" style="font-size: clamp(80px, 14vw, 200px);">Services</div>
  ...
  <div class="relative z-10">
    ...
    <h1 class="font-serif text-5xl md:text-6xl italic font-normal leading-tight mb-10 max-w-3xl">We build brands that move markets.</h1>
    ...
    <div class="flex gap-24 text-sm">
      <div>
        <div class="font-serif text-4xl italic text-white mb-1">6</div>
        <div class="text-text-secondary/45">Core Practice Areas</div>
      </div>
      <div>
        <div class="font-serif text-4xl italic text-white mb-1">$2M+</div>
        <div class="text-text-secondary/45">Ad Spend Managed</div>
      </div>
      <div>
        <div class="font-serif text-4xl italic text-white mb-1">25+</div>
  ...
  <div class="px-12 py-24">
    ...
    <div class="grid grid-cols-4 gap-0.5 bg-mid">
      <div class="bg-mid p-12 border border-transparent hover:border-accent transition">
        ...
        <h3 class="font-serif text-2xl italic font-normal mb-3">Full Engagement</h3>
      ...
      <div class="bg-mid p-12 border border-transparent hover:border-accent transition">
        ...
        <h3 class="font-serif text-2xl italic font-normal mb-3">Brand Sprint</h3>
      ...
      <div class="bg-mid p-12 border border-transparent hover:border-accent transition">
        ...
        <h3 class="font-serif text-2xl italic font-normal mb-3">Retainer</h3>
      ...
      <div class="bg-mid p-12 border border-transparent hover:border-accent transition">
        ...
        <h3 class="font-serif text-2xl italic font-normal mb-3">Consulting</h3>
  ...
  <div class="px-12 py-24">
    ...
    <div class="space-y-0">
      ...
      <a href="/services/<?= htmlspecialchars($service['slug'] ?? '') ?>" class="grid grid-cols-[56px_1fr_200px_80px] gap-8 py-10 border-t border-border hover:bg-white/2 transition">
        ...
        <div>
          <h3 class="font-serif text-2xl italic font-normal"><?= htmlspecialchars($service['title']) ?></h3>
        </div>
  ...
  <div class="px-12 py-24">
    <div class="flex justify-between items-end mb-16">
      <div>
        ...
        <h2 class="font-serif text-4xl italic font-normal leading-tight">How we get<br>from brief to deployed.</h2>
      </div>
    </div>
    ...
    <div class="grid grid-cols-5 gap-0 border-b border-border">
      <div class="pb-12 pr-8 border-r border-border">
        ...
        <h3 class="font-serif text-lg italic font-normal mb-3">Discovery</h3>
      ...
      <div class="pb-12 px-8 border-r border-border">
        ...
        <h3 class="font-serif text-lg italic font-normal mb-3">Strategy</h3>
      ...
      <div class="pb-12 px-8 border-r border-border">
        ...
        <h3 class="font-serif text-lg italic font-normal mb-3">Creation</h3>
      ...
      <div class="pb-12 px-8 border-r border-border">
        ...
        <h3 class="font-serif text-lg italic font-normal mb-3">Refinement</h3>
      ...
      <div class="pb-12 pl-8">
        ...
        <h3 class="font-serif text-lg italic font-normal mb-3">Deploy</h3>
  ...
  <div class="px-12 py-24">
    ...
    <div class="grid grid-cols-3 gap-0.5 bg-mid">
      <div class="bg-mid p-12">
        ...
        <p class="font-serif text-lg italic leading-relaxed mb-8 text-text-secondary/75">
...
<section class="border-b border-border relative overflow-hidden">
  ...
  <div class="relative z-10 px-12 py-32 text-center">
    ...
    <h2 class="font-serif text-5xl md:text-6xl italic font-normal leading-tight max-w-3xl mx-auto mb-10">
