...
<section class="min-h-screen px-12 py-32 flex items-center justify-center border-b border-border relative overflow-hidden">
  ...
  <div class="relative z-10 max-w-2xl w-full text-center">
    ...
    <h1 class="font-serif text-5xl md:text-6xl italic font-normal leading-tight mb-8">
    ...
    <div class="grid grid-cols-2 gap-12 mb-16">
      ...
      <div>
        ...
        <a href="mailto:dough@casestudy-labs.com" class="font-serif text-2xl italic text-white hover:text-accent transition">
      ...
      <div>
        ...
        <a href="https://calendar.app.google/wjzdm2J4EUE1oxh36" target="_blank" class="font-serif text-2xl italic text-white hover:text-accent transition">
          Google Calendar ↗
        </a>
  ...
  <div class="px-12 py-24">
    <div class="grid grid-cols-2 gap-24">
      <div>
        ...
        <h2 class="font-serif text-3xl md:text-4xl italic font-normal leading-tight mb-8">We don't chase clients.<br>We partner with founders.</h2>
  ...
  <div class="px-12 py-24">
    ...
    <div class="grid grid-cols-4 gap-0 border-b border-border">
      <div class="pb-12 pr-8 border-r border-border">
        ...
        <h3 class="font-serif text-lg italic font-normal mb-3">Discovery Call</h3>
      ...
      <div class="pb-12 px-8 border-r border-border">
        ...
        <h3 class="font-serif text-lg italic font-normal mb-3">Proposal</h3>
      ...
      <div class="pb-12 px-8 border-r border-border">
        ...
        <h3 class="font-serif text-lg italic font-normal mb-3">Kickoff</h3>
      ...
      <div class="pb-12 pl-8">
        ...
        <h3 class="font-serif text-lg italic font-normal mb-3">Delivery</h3>
